package ec.edu.luisrogerio.app.handler;
...
import ec.edu.luisrogerio.common.exception.ResourceNotFoundException;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleVeronicaException(AppException ex, HttpServletRequest request) {
    ...
    private ResponseEntity<Object> buildResponseEntity(ApiError apiError) {
        AppResponseDTO<ApiError> error = new AppResponseDTO<>(false, apiError);
