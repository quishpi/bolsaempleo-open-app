...
@Component
@Scope("view")
public class ReferenciaProfesionalBean implements Serializable {

	private static final long serialVersionUID = 1L;

	private List<ReferenciaProfesional> elements;
	private ReferenciaProfesional selectedElement;
	private List<ReferenciaProfesional> selectedElements;
	...
	@Autowired
	private ReferenciaProfesionalService entityService;
	...
	public void openNew() {
		this.selectedElement = new ReferenciaProfesional();
	}
